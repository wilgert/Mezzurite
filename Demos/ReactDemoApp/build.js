...
const REACT_DIR = `node_modules/@microsoft/mezzurite-react/`;
...
shell.echo(`Start building Mezzurite.React...`);
// shell.cd(`..`);
// shell.cd(`Mezzurite.React`);
// shell.exec(`npm run build`);
shell.cp(`-R`, [`../../Mezzurite.React/dist/`], `${REACT_DIR}`);
shell.echo(chalk.green(`Mezzurite.React completed`));
